...
if ( $_GET["id"] ) {
    ...
    echo '<input type="submit" name="prev" value="<< Prev" style="height:25px; width:100px" onClick="window.location=\'start2.php?id=' . ($id-1) . '\';"/>';
    echo '<br>';
    echo '<br>';
    echo '<input type="submit" name="next" value="Next >>" style="height:25px; width:100px" onClick="window.location=\'start2.php?id=' . ($id+1) . '\';"/>';
} else {
